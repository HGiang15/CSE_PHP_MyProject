...
<body>
    ...
    <section>
        <div class="m-5 text-center">
            <div class="mx-5">
                <form action="?controller=class1&action=process_add" method="post">
                    <h2 class="mb-4">THÊM MỚI LỚP</h2>
                    <div class="input-group flex-nowrap mb-3">
                        <span class="input-group-text ms-5" id="addon-wrapping">Tên lớp</span>
                        <input type="text" class="form-control me-5" aria-label="nameClass1" aria-describedby="addon-wrapping" name="nameClass1">
                    </div>
