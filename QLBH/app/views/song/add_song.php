...
<body>
    ...
    <section>
        <div class="m-5 text-center">
            <div class="mx-5">
                <form action="?controller=song&action=process_add" method="post">
                    <h2 class="mb-4">THÊM MỚI BÀI HÁT</h2>
                    <div class="input-group flex-nowrap mb-3">
                        <span class="input-group-text ms-5" id="addon-wrapping">Tên bài hát</span>
                        <input type="text" class="form-control me-5" aria-label="nameSong" aria-describedby="addon-wrapping" name="nameSong">
                    </div>
                    <div class="input-group flex-nowrap mb-3">
                        <span class="input-group-text ms-5" id="addon-wrapping">Ca Sỹ</span>
                        <input type="text" class="form-control me-5" aria-label="singer" aria-describedby="addon-wrapping" name="singer">
                    </div>
                    <div class="input-group mb-3">
                        <label class="input-group-text ms-5" for="inputGroupSelect01">Mã thể loại</label>
